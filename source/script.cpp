...
//}
//
//cppscript::operator_info_t *word_t::get_mapping_operator() {
//    return (operator_info_t*) nullptr;
//}
//
...
//
//
//void cppscript::separate_script_by_syntax(const std::string &script, std::vector<word_t> &words) {
...
//            words.emplace_back(word_buf,word_t::e_variable);
//            invalid_word = false;
//        }
//        script_current_index += word_length;
//
//        for (map<string,operator_info_t>::iterator iter = operator_info_table.begin();iter != operator_info_table.end();++iter) {
//            const string& name = iter->first;
//            if (name.length() > script.length() - script_current_index)
//                continue;
//            if (!script.compare(script_current_index, name.length(), name.c_str())){
//                words.emplace_back(name,word_t::e_variable);
